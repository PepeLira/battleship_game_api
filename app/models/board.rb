class Board < ApplicationRecord
    ...
    predef_board = { 
        ...
        "boat_3" => [[[5,2],[6,2],[7,2]], [[3,15],[4,15],[7,15]], [[2,4],[3,4],[4,4]], [[2,14],[2,15],[2,16]], [[4,6],[4,7],[4,8]] ],
    ...
    def create_boats
        ...
        players.each do |player|
            boat_2 = Boat.new(state: "alive", n_of_cells: 2, game_player_id: player.id, board_id: id)
            boat_2.save! 
            boat_2.set_coordinates(get_rand_boat("boat_2"))
            boat_3 = Boat.new(state: "alive", n_of_cells: 3, game_player_id: player.id, board_id: id)
            boat_3.save!
            boat_3.set_coordinates(get_rand_boat("boat_3"))
            boat_5 = Boat.new(state: "alive", n_of_cells: 5, game_player_id: player.id, board_id: id)
            boat_5.save!
